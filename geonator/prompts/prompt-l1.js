...
- ただし**どのtypeにも当てはまらない非地理的な特徴**（築浅・壁が赤い・ペット可 等）はシステムが検知できないので、従来どおり confirmation で「〜は対応できていない」と述べる（conditions配列には入れない）。
- type:
...
- negate: **反転条件**。その条件物が「無い/入っていない/避けたい/離れている」ことを求めている場合に true。
  ...
  「線路沿いではない家」→ {type:road, text:"線路", negate:true}。
