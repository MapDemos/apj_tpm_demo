...
- \`target\`：\`{ "text", "query_intent" }\`。query_intent = category_mansion | category_apartment | category_building | specific | category_busstop | category_busstop_location | intersection | signal（**"specific" でも必ず出す**）
