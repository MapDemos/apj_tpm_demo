...
- **判定の指針**：物件系(マンション/家/ビル)が1つなら target 確定・チェーン店(ローソン/スタバ等)は原則 condition・「〜が目の前/〜から○分/〜の近く」等の距離修飾が付いた名詞は condition 確定 → これらで役割が決まるなら interpretations は空。**構造マーカーの無い名詞の羅列**で初めて割れる。
