...
- **飲食の下位分類に注意**：意図が飲食店（ラーメン屋・寿司屋・カフェ等）の場合、地図データはその店を上位/隣接カテゴリで持つことが多い（例：ラーメン屋→「レストラン>和食」「レストラン>中華」「レストラン」「food_and_drink」）。**意図の料理を提供し得る飲食カテゴリは全て残す**。飲食意図に対して remove してよいのは「銀行」「コンビニ」「病院」等の明確な非飲食だけ。
  - 例）意図「ラーメン屋」→「レストラン>和食」「レストラン>中華」「レストラン」= 残す。「コンビニ」「ドラッグストア」= remove。
- 迷ったら remove しない。
